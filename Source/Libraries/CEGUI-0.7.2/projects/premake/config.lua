...
OGRE_PATHS = { "../Ogre/Sources/ogre_src_v1-7-1/", "OgreMain/include", "lib" }
OIS_PATHS = { "../Ogre/Sources/ogre_src_v1-7-1/Dependencies", "include/OIS", "lib" }
...
--
CEGUI_EXTRA_PATHS = {
     { "C:/Program Files (x86)/boost/boost_1_42", "", "lib", "CEGUIOgreRenderer" },
}
